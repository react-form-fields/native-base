...
const ValidationContext = React.memo(
  React.forwardRef<IValidationContextRef, IValidationContextProps>(
      ...
      React.useEffect(() => {
        ...
        fieldsMap[fieldId] = {
          ...
          goNext(currenPosition: number): boolean {
            ...
            InteractionManager.runAfterInteractions().then(() => nextField.onFocusHandler());
